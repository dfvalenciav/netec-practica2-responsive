...
class CardController { final _eventController = StreamController<ControllerEvent>.broadcast(); 
...
void swipe(CardSwipeDirection direction) { _eventController.add(ControllerSwipeEvent(direction)); } 
// Change the top card to a specific index. 
void moveTo(int index) { _eventController.add(ControllerMoveEvent(index)); } 
